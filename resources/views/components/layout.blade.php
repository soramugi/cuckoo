                            ...
                            <ul role="list" class="flex flex-1 flex-col gap-y-7">
                                <li>
                                    <ul role="list" class="-mx-2 space-y-1">
                                        ...
                                        <li>
                                            <a href="{{ $menu['link'] }}"
                                                class="{{ ($menu['current']) ? 'bg-indigo-700 text-white' : 'text-indigo-200 hover:text-white hover:bg-indigo-700' }} group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold">
                                                {!! $menu['icon'] !!}
                                                {{ $menu['name'] }}
                                            </a>
                                        </li>
                            ...
                            <ul role="list" class="-mx-2 mt-2 space-y-1">
                                ...
                                <li>
                                    <a href="#"
                                        class="text-indigo-200 hover:text-white hover:bg-indigo-700 group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold">
                                        <span
                                            class="flex h-6 w-6 shrink-0 items-center justify-center rounded-lg border border-indigo-400 bg-indigo-500 text-[0.625rem] font-medium text-white">{{ $team['icon'] }}</span>
                                        <span class="truncate">{{ $team['name'] }}</span>
                                    </a>
                                </li>
                                @endforeach
